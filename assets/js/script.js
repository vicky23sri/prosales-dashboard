$(document).ready(function () {
    ...
    if ($('.datanew').length > 0) {
        $('.datanew').DataTable({
            ...
            "language": {
                ...
                info: '', // Hide info text by setting to empty string
            },
    ...
    var Sidemenu = function () { this.$menuItem = $('#sidebar-menu a'); }; function init() {
        var $this = Sidemenu; $('#sidebar-menu a').on('click', function (e) {
            ...
            console.log("Clicked submenu item: " + fileName);
    ...
    var right_side_views = '<div class="right-side-views d-none">' +
        ...
        '<img src="http://127.0.0.1:5502/images/logo%20copy.png" alt="Logo" class="img-flex">' +
        '</a>' +
        '</div>' +
        '</div>' +
        '<div class="col-xl-6 col-sm-6 col-12">' +
